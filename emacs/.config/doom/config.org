...
** [[https://github.com/doomemacs/doomemacs/issues/7080][Issue#7080]]

The following error occurs because some packages use function only available in Emacs 29.

#+begin_src emacs-lisp :tangle no
Error (doom-first-file-hook): Error running hook "global-git-commit-mode" because: (void-variable transient-base-map)
#+end_src

The [[https://github.com/doomemacs/doomemacs/issues/7078#issuecomment-1428775097][solution]] is to pin =transient= and =with-editor= to a previous version.
